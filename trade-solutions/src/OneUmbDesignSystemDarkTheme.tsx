...
import { ReactComponent as InfoOutlined1 } from 'src/assets/images/_InfoOutlined.svg';
...
const darkQuestTheme = createTheme(
  {
    components: {
      ...
      MuiAlert: {
        defaultProps: {
          iconMapping: {
            error: <SvgIcon component={InfoOutlined} />,
            warning: <SvgIcon component={WarningAmberOutlined} />,
            info: <SvgIcon component={InfoOutlined1} />,
