...
import Vector11Image from 'src/assets/images/mainPage_Vector_12.png';
import Vector12Image from 'src/assets/images/mainPage_Vector_13.png';
import Vector13Image from 'src/assets/images/mainPage_Vector_14.png';
import Vector14Image from 'src/assets/images/mainPage_Vector_15.png';
import Vector15Image from 'src/assets/images/mainPage_Vector_16.png';
import Vector16Image from 'src/assets/images/mainPage_Vector_17.png';
import Vector17Image from 'src/assets/images/mainPage_Vector_18.png';
import Vector18Image from 'src/assets/images/mainPage_Vector_19.png';
import Vector19Image from 'src/assets/images/mainPage_Vector_20.png';
              ...
              <AchFIleGrid>
                ...
                <Frame>
                  <DataGridHeader>
                    <Container5>
                      <Typography17>
                        <Typography18>{`Date/Time (CST)`}</Typography18>
                      </Typography17>
                      <Icon12>
                        <ArrowUpwardFilled>
                          <Vector11
                  ...
                  <DataGridHeader1>
                    <Container6>
                      <Typography19>
                        <Typography20>{`Profile Name`}</Typography20>
                      </Typography19>
                      <Icon13>
                        <ArrowUpwardFilled1>
                          <Vector12
                  ...
                  <DataGridHeader2>
                    <Container7>
                      <Typography21>
                        <Typography22>{`Last Path/Filename`}</Typography22>
                      </Typography21>
                      <Icon14>
                        <ArrowUpwardFilled2>
                          <Vector13
                  ...
                  <DataGridHeader3>
                    <Container8>
                      <Typography23>
                        <Typography24>{`User ID`}</Typography24>
                      </Typography23>
                      <Icon15>
                        <ArrowUpwardFilled3>
                          <Vector14
                  ...
                  <DataGridHeader4>
                    <Container9>
                      <Typography25>
                        <Typography26>{`File Size`}</Typography26>
                      </Typography25>
                      <Icon16>
                        <ArrowUpwardFilled4>
                          <Vector15
                  ...
                  <DataGridHeader5>
                    <Container10>
                      <Typography27>
                        <Typography28>{`Status`}</Typography28>
                      </Typography27>
                      <Icon17>
                        <ArrowUpwardFilled5>
                          <Vector16
